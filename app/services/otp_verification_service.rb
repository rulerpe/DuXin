class OtpVerificationService
    ...
    def start_verification(to)
        ...
        verification = @twilio_client.verify.v2.services(service_sid).verifications.create(to: to, channel: channel)
    ...
    def check_verification(phone, otp_code)
        service_sid = Rails.application.credentials.twilio[:service_sid]
        begin
            verification_check = @twilio_client.verify.v2.services(service_sid).verification_checks.create(to: phone, code: otp_code)
